...
def getTable():
    with open('/Users/HP/.spyder-py3/Summer_Research/centre_mens-basketball_2019-20_3907_greenville.html', 'r') as f:
...
def makeHeaderPBP(sport, year1):
    ...
    game = 1
    game_url = 'file:///C:/Users/HP/.spyder-py3/Summer_Research/centre_mens-basketball_2019-20_3907_greenville.html'
    print(game_url)
    print(game)
    ...
    header = open('/Users/HP/.spyder-py3/Summer_Research/mens-basketball/SAA/centrecolonels/headers/2019-20/centre_mens-basketball_2019-20_3907_greenville_header_1.csv', 'r')
    ...
    path = '/Users/HP/.spyder-py3/Summer_Research/centre_mens-basketball_2019-20_3907_greenville.html'

    if os.path.exists(path):
        table = open('/Users/HP/.spyder-py3/Summer_Research/centre_mens-basketball_2019-20_3907_greenville.html', 'r')
        ...
        table_data = list(csv.reader(centre_column))
        ...
        output_dir = Path('/Users/HP/.spyder-py3/Summer_Research')
